...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/examples/smart-home/sensors/sensor_temperature/client.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>59.76493605156124</x>
        <y>90.58193984843899</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>84.07815321932803</x>
        <y>73.65836591903566</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>24.529093198171473</x>
        <y>107.87788519455532</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>2.991224027067683 0.0 0.0 2.991224027067683 9.241623427083395 -61.97539064997552</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
