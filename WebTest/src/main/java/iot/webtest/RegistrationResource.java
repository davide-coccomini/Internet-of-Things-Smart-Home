...
public class RegistrationResource extends CoapResource {
    ...
    public void handlePOST(CoapExchange exchange) {
        ...
        if (contentJson != null && contentJson.has("MoteInfo")){
            ...
            ServerCoap.freeMotes.add(new Mote(moteIP, moteType, moteResource));
            ...
            ServerCoap.assignedMotes.put(moteNames[count], new Mote(moteIP, moteType, moteResource));
            count++;
            ...
            new CoapHandler() {
                public void onLoad(CoapResponse response) {
                    ...
                    if (contentJson != null && contentJson.has("MoteValue")){
                        ...
                        Mote mote = ServerCoap.assignedMotes.get(moteName);
                        if(mote != null){
